...
public class MemberDto {
    ...
    public MemberDto(String memberId, String memberName, String dob, String address, String phone, String memShipDate, String memExDate) {
    ...
    public String toString() {
        return "MemberDto{" + "memberId=" + memberId + ", memberName=" + memberName + ", dob=" + dob + ", address=" + address + ", phone=" + phone + ", memShipDate=" + memShipDate + ", memExDate=" + memExDate + '}';
    }
